...
Original file is located at
    https://colab.research.google.com/drive/1zaQvr6hhyiiWTZhhLTCJN9OACRcCybe3

#Exercise 1

Goal: Implement, run, and verify a complete multiple linear regression pipeline on 50_Startups.csv
